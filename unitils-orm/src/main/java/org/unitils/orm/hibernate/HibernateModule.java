 ...
 * <p/>
 * A Hibernate <code>SessionFactory</code> is created when requested and injected into all fields or methods of the
 * test
      ...
      implements Module, Flushable
{
   ...
   protected Session doGetActivePersistenceContext(Object testObject)
   {
      SessionHolder sessionHolder =
            (SessionHolder) TransactionSynchronizationManager.getResource(getPersistenceUnit(testObject));
   ...
   {
      ConfiguredOrmPersistenceUnit<SessionFactory, Configuration> configuredPersistenceUnit =
            getConfiguredPersistenceUnit(testObject);
   ...
   protected void getDatabaseName(Object testObject, Method testMethod)
   {
      ...
      Set<HibernateSessionFactory> lstDataSources =
            AnnotationUtils.getFieldLevelAnnotations(testObject.getClass(), HibernateSessionFactory.class);
